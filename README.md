...
| unsigned long long | 0 ถึง 18,446,744,073,709,551,615 | เอาไว้รับโจทย์ที่มันมากๆๆ ถ้าอันนี้ไม่ได้ก็ไปใช้ [bignum](https://www.geeksforgeeks.org/bigint-big-integers-in-c-with-example/) ซะ | 8 |
| float | 1.175E-38 ถึง 3.402E+38 | เอาไว้รับค่าเป็นทศนิยม | 4 |
| double | 2.225E-308 ถึง 1.797E+308 | ทศนิยมเหมือนกันแค่ดีกว่า | 8 |
| bool | true/false | เอาไว้เก็บค่าว่าจริงหรือเท็จตาม [logic](https://www.w3schools.com/cpp/cpp_operators_logical.asp) เลย | 1 |
