...
เป็นแนวที่พบได้บ่อยใน TOI จะเป็นการแบ่งช่วงแล้วให้เอาช่วงนั้นๆไปคิด ให้ได้คำตอบที่ดีที่สุด

### ตัวอย่างโจทย์ Partitioning TOI18_sausage

[source : programming.in.th - TOI18_Sausage](https://programming.in.th/tasks/toi18_sausage)

> มีไส้อั่วที่เป็นรูปทรงกลมเรียงต่อกันเป็นสายยาวทั้งหมด n ลูก แต่ละลูกมีค่าความอร่อยเป็นของตัวเอง เราสามารถเลือกกินไว้อั่วได้แค่ลูกลำดับแรกของสาย และลูกลำดับสุดท้ายของสายเท่านั้น แต่ละครั้งในการกินไส้อั่วทิพย์ ความอร่อยของไส้อั่วชิ้นที่เลือก (x) กับความอร่อยของชิ้นปลายสายอีกด้านที่ไม่ได้กิน (y) จะผสมผสานกันเกิดเป็นความอร่อยทิพย์ซึ่งมีค่าเท่ากับ |x - y| เราสามารถตัดสายไส้อั่วออกเป็นเส้นเล็ก ๆ ได้หลายเส้นก่อนจะลงมือกิน หาผลรวมของความอร่อยในการกินไส้อั่วที่มีค่ามากที่สุด
