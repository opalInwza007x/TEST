...
ผมขอกราบสวัสดีกันอีกรอบครับ ในช่วงเวลาทั่วไปเนี่ย ผู้คนมักจะเรียกผมว่า "โอปอ" แต่ในวงการนี้หลายๆคนคงรู้จักผมในนาม "opal_Inwza007x" เนื่องจากผมพึ่งผ่านประสบการณ์ที่แสนจะสนุกสนาน(?)ในค่ายนี้มา ผมเลยอยากจะมาช่วยยกระดับพื้นฐานของผู้คนที่สนใจในสอวน. คอมพิวเตอร์กันสักหน่อย 

ในการเข้าค่ายโอลิมปิกคอมพิวเตอร์ ก็จะได้เรียนเกี่ยวกับพวก Competitive Programming อารมณ์ประมาณเขียนโปรแกรมเพื่อคำณวนอะไรสักอย่าง เพราะฉะนั้นพอผมไปเข้าค่ายแล้ว ผมก็ยังไม่สามารถซ่อมอุปกรณ์ได้ทุกชนิดนะครับ555 สำหรับในค่ายเนื้อหาหรือทฤษฎีส่วนใหญ่ในแต่ละเรื่องคงมีไม่กี่หน้ากระดาษหรอกครับ ที่ยากคือการเอาไปประยุกต์ใช้ ซึ่งเกิดจากการฝึกทำโจทย์บ่อยๆ แล้วในช่วงที่เราเจอทางตันด้านเนื้อหา จะรู้สึกค่อนข้างท้อเลย 
...
opal_Inwza007x ก็เป็นเด็กธรรมดาคนนึงที่เก่งคณิตนิดหน่อย จนกระทั้งได้ตกค่าย 1 ของสอวน. คอมพิวเตอร์ ตอนม.4 ในปีนั้นเป็นปีที่ได้เข้าค่ายในรูปแบบออนไลน์พอดี(โดนโควิดถล่ม T^T) ในตอนที่ได้รู้ว่าตัวเองติดแค่ค่ายคอมพิวเตอร์ ก็รู้สึกเสียดายนิดๆเพราะมาสอบตามเพื่อน อยากเข้าคณิตมากกว่าอะ(>:/) ปีนั้นก็เลยไม่ได้ตั้งใจเรียนเลย แต่พอตอนจะไปสอบจริงๆก็มีความรู้สึกอยากได้ไปต่อแบบเท่ๆอยู่ ติดที่ว่าตอนอาจารย์สอนก็กดแรงค์อยู่นี่สิ พอกลับไปอ่านโค้ดอาจารย์ที่เก็บเอาไว้ กลับไม่เข้าใจสักอย่างเลย
...
ตอนแรกก็คิดไว้ว่า "นี่ไม่ใช่สายของเรา คงมาได้แค่นี้แหละ" แล้วคราวหลังก็มารู้ครับว่าถ้าแค่เขียนพวก Data structure อะไรพวกนี้ส่งมั่วๆไป ก็พอจะได้ไปต่อแล้ว

หลังจบค่ายมาช่วงแรกๆ ผมก็ไม่ได้รู้สึกอะไรมากครับ นี่ก็คงไม่ใช่วืชาที่ผมต้องใช้ในอนาคตสักหน่อย แต่ยิ่งเวลาผ่านไปนานเท่าไหร่ ผมยิ่งรู้สึกเจ็บใจมากขึ้นเท่านั้น ผมกลับคิดอยู่ตลอดว่า "ถ้าผมแค่พยายามมากกว่านี้อีกนิดหน่อยก็คงได้ไปต่อแล้ว" ถ้ายังมีโอกาสอีกผมจะไปถล่มค่ายนี้ให้ดู ในตอนนั้นผมตัดสินใจที่จะเดินบนเส้นทางสอวน. คอมพิวเตอร์ ผมจะพยายามไปจนกว่าจะ __ไม่มีคำว่า "ยังไม่ได้ทำดีที่สุด"__ ออกมาจากความคิดผมอีกเลย จากคนที่แทบไม่เคยพยายามกับเรื่องเรียน กลายเป็นคนที่ทำโจทย์ทุกเวลาว่างที่มีโอกาส ไม่รู้ว่าตั้งแต่เมื่อไหร่ จากที่แต่ก่อนเป็นคนที่ชอบเล่นเกมอยู่บ่อยๆ ตอนนี้การทำโจทย์มันสนุกกว่าการเล่นเกมเสียอีก 

ผ่านมาครึ่งปี ถึงเวลาที่จะไปสอบเข้าค่าย 1 ใหม่อีกรอบ 
ปีนั้นเป็นปีที่ตั้งใจจะลงคอมมากๆ แม้คราวก่อนจะเคยสอบติดไปแล้ว แต่รอบนี้กลับกดดันกว่าเดิม เนื่่องจากในตอนนั้น opal_Inwza007x ดันฟิตเนื้อหาค่ายมากไป ทำให้ฝีมือคณิตศาสตร์ที่ต้องใช้สอบเข้าค่าย 1 ดรอบปลงพอสมควร ถ้าพลาดครั้งนี้ผมคงไม่มีโอกาสแก้ตัวอีกเพราะก็อยู่ม.5 แล้ว เนื้อหาที่ผมเตรียมตัวมาครึ่งปีคงไม่ได้แสดงศักยภาพให้ใครดู ผลออกมาก็คือติดครับ แสดงว่าความสามารถผมน่าจะถึงอยู่แล้วแน่ๆเลย(โม้ว่ะ) เอาล่ะได้เวลาลองท้าทายค่ายวิชาการนี้ดูแล้ว...
...
อาหารช่วงเบรคนี่ก็อยากกินอะไรเขามีหมดครับ(อย่าลืมไปปิ้งหนมปังทาแยม กับกดโอวันติลด้วยนะ) 
...
แล้วก็ในค่ายนผมอยากให้ทุกคนระวัง item นึงไว้ครับ สิ่งนั้นคือ Master key มันเป็นได้หลายอย่างครับ เช่น เหรียญบาท ช้อนเล็กๆ ฯลฯ 
...
พอถ่ายรูปรวมเสร็จผมก็เริ่มสังเกตุได้ครับ ในปีนั้นต่างจากปีก่อนเยอะเลย จากที่ปีก่อนต่างคนต่างกลับบ้านคุยกับแค่คนที่รู้จักกัน ปีนี้ทุกคนกลับพูดคุยและจากลากันอย่างสนุกสนาน 
จากที่ปีก่อนผมเดินกลับบ้านอย่างหมดหวัง ปีนี้ผมได้อันดับต้นๆกลับบ้านแบบเท่ๆ บางคนก็ได้รู้จักกับเพื่อนต่างโรงเรียน บางคนอยู่โรงเรียนเดียวกันก็พึ่งได้มีโอกาสได้รู้จักกัน 
...
หลังจากนั้นผมก็ไม่ลังเลที่จะเรียนเนื้อหาค่ายเพิ่มอีกครับ ถ้าผมไม่เข้าใจเรื่องไหน ผมจะเขียนการทำงานของ Algorithm ใส่กระดาษไม่ว่าจะกี่แผ่น จะถามพี่ค่ายแม้พี่เขาจะนั่งกินซอยจุ๊อยู่ 
...
ในค่ายนี้ผมพร้อมแบบเดือดจัดๆเลยครับ ผ่านมา 5 เดือนจากค่ายแรก ได้เรียนรู้เทคนิคมามากมายก่อนที่จะมาเข้าในค่าย 2 นี้ ปีนั้นได้เข้าที่มหาวิทยาลัยขอนแก่นเลย เอาไปอวดเพื่อนได้555 
เนื่องจากค่าย 1 ทำความเป็นอยู่ไว้ดีมาก ผมจึงคาดหวังว่าค่ายนี้จะได้กินดีอยู่ดีขึ้น ซึ่งเนื้อหาในค่ายนี้ก็ทำอะไรผมไม่ได้ครับ ผมเก็บมาหมดทุกอย่างก่อนเข้าค่ายแล้ว 😈 
...
หลังสอบท้ายค่ายเสร็จก็มีเลี้ยง Pizza + KFC ด้วย(แซ่บๆครับ) ในค่ายนี้ทุกคนก็ดูสนิทกันขึ้นเยอะเลย ดีไม่ดีขึ้นมหาลัยอาจจะได้เจอกันก็ได้ ใครที่ยังมีปีหน้าแล้วอยากจะมาแก้แค้นก็สู้ๆนะครับ หลังจากได้ร่ําลากัน ในระหว่างทางกลับบ้าน ผมได้คิดเรื่องมากมาย ตั้งแต่ผมที่ยังเขียน Loop ไม่เป็น ผ่านมาปีกว่าก็ได้เป็นผู้แทนศูนย์ซะละ ถึงแม้ผลสอบผมจะได้อันดับแรกของค่าย แต่ผมจะไม่เหลิงเหมือนตัวเองแต่ก่อนอีกแล้วครับ ยังมีคนที่เก่งกว่าผมอีกเยอะ ต่อจากนี้จะพยายามเต็มที่สำหรับการไปแข่ง TOI19 ครับ orz orz orz
...
ในพิธีเปิดก็ยิ่งใหญ่มากๆๆ เนื่องจากมีพิธีเปิดพร้อมกับ TChO20 ซึ่งผมก็ไปนั่งเปื่อยประมาณ 4 ชม. อาหารการกินอยู่ในระดับค่าย 2 ที่ไม่มีไก่ครับ555 
ผู้คนเฉลี่ยในการแข่งโดยเฉลี่ยมักจะ(เกียน)เก่งมาก ซึ่งใครมาทักแล้วผมจำไม่ได้ก็ขอโทษด้วยนะครับ ไม่ค่อยจำหน้าคนครับ555 ผมไปถึงก็ไม่มีไรมากครับ มีทดสอบระบบวันนึงแล้ววันถัดมาไปแข่งเลย

ปล. มีเฉลยแบบเทพๆจากท่าน [krist7599555](https://github.com/krist7599555/toi/tree/master/toi19) มาฝาก orz orz orz

เนื่องจากผมไม่ใช่เด็กกิจกรรม แล้วการไปแข่งในครั้งนี้ส่วนใหญ่ได้ไปเที่ยววัดที่แดดพร้อมสลายผิวขาวของคุณ ผมจึงขอข้ามไปในตอนแข่งเลยนะ555

ในการสอบนี้ผมก็ไม่คิดไรมากครับ ผมเชื่อว่าสิ่งที่ผมได้มาคือสิ่งที่ดีที่สุดที่ผมสามารถทำได้แล้วไม่ว่าผมจะได้หรือไม่ได้อะไรกลับบ้านก็ตาม ซึ่งจากที่ผมลอง TOI ปีก่อนๆผมคงอยู่แค่ระดับทองแดงถ้าข้อสอบแนวทั่วไป แต่จะได้ระดับเงินถ้ามีโจทย์ง่ายเยอะหน่อย
<details>
