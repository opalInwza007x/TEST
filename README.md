...
ถ้าให้อธิบายก็ กำหนดให้ $a_i$ เป็นการทำงานลำดับที่ i เมื่อค่าของ i = 0, 1, 2, ...m และให้ $b_j$ เป็นการทำงานลำดับที่ j เมื่อค่าของ j = 0, 1, 2, ...m โดยในการทำงานของ $a_i$ แต่ละครั้งก็จะทำงาน $b_j$ ทั้งหมด n ครั้ง
