...
Array เอาไว้ใช้ตอนที่โจทย์จะนำค่าที่รับมาหลายๆอันไปใช้ต่อ โดยมีการประกาศแบบนี้
...
มาทำความรู้จักกับ index ดีกว่า ในทางคอมพิวเตอร์เนี่ยจะเริ่มที่ index 0, 1, 2, ... , n - 1 อย่างถ้าเราเขียนแบบนี้

อย่างเช่นถ้าโจทย์อยากนำค่าไปเก็บใน array แล้วแสดง output ทั้งหมด

    const ll maxn = 105; // แล้วแต่เรากำหนด จะเปลี่ยนแปลงตามโจทย์
    ll arr[maxn];
