...
[source : programming.in.th - Equipped](https://programming.in.th/tasks/1036)

> มีเครื่องมือ `n` ชิ้น แต่ละชนิดมีราคาเป็นของตัวเอง โดยเราต้องการนำเครื่องมือไปใช้ทั้งหมด `k` แบบ ให้หาจำนวนเงินที่น้อยที่สุดในการซื้ออุปกรณ์แล้วสามารถใช้งานได้ทั้ง `k` แบบ

### Test Case#1

มีอุปกรณ์ 5 ชนิด ต้องการนำไปใช้งาน 3 แบบ (1 คือสามารถนำไปใช้งานแบบนั้นได้ otherwise ไม่สามารถใช้งานในแบบนั้นได้)

| ราคา | ใช้แบบที่ 1 | ใช้แบบที่ 2 | ใช้แบบที่ 3 |
| :---: | :---: | :---: | :---: |
| 25 | 1 | 0 | 1 |
| 30 | 0 | 1 | 1 |
| 5 | 1 | 0 | 0 |
