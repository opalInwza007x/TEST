...
บรรทัดที่ 2 เป็นการย่อโค้ดให้สั้นขึ้น เช่น ถ้าไม่มีบรรทัดนี้เราจะต้องพิมพ์คำสั่ง cin >> x; เฉยๆ กลายเป็น std::cin >> x;
...
| ชื่อ | เอาไว้รับค่า | นิยมใช้กับ |
| --- | --- | --- |
| int | -2,147,483,647 ถึง 2,147,483,647 | ไว้รับค่าตัวเลขเฉยๆตั้งแต่ -(2^31-1) ถึง 2^31-1 |
| signed int | 0 ถึง 4,294,967,295 | นิยมใช้ int มากกว่าอะ |
| long long | -9,223,372,036,854,775,807 ถึง 9,223,372,036,854,775,807 | ไว้รับค่าตัวเลขที่มากหน่อยตั้งแต่ -(2^63-1) ถึง 2^63-1 |
| unsigned long long | 0 ถึง 18,446,744,073,709,551,615 | เอาไว้รับโจทย์ที่มันมากๆๆ ถ้าอันนี้ไม่ได้ก็ไปใช้ (bignum)[https://www.geeksforgeeks.org/bigint-big-integers-in-c-with-example/] ซะ |
| float | 1.175E-38 ถึง 3.402E+38 | เอาไว้รับค่าเป็นทศนิยม |
| double | 2.225E-308 ถึง 1.797E+308 | ทศนิยมเหมือนกันแค่ดีกว่า |
| char | เอาไว้เก็บตัวอักษรเป็น [ascii](https://th.wikipedia.org/wiki/%E0%B9%81%E0%B8%AD%E0%B8%AA%E0%B8%81%E0%B8%B5) | รับค่าตัวอักษรที่มีแค่ตัวเดียวแน่ๆ |
| string | เป็น char หลายตัวๆ เหมือนเป็น dynamic char array | รับค่าตัวอักษรที่มีหลายๆตัวได้ |
