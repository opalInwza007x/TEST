...
จะมีฟังก์ชันช่วยที่ได้ใช้บ่อยๆตามนี้ โดยต้อง __${\color{green}#include }$__ __${\color{green}<cmath>}$__ หรือ __${\color{green}#include }$__ __${\color{green}<bits/stdc++.h>}$__ ก่อน
