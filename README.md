...
c++ มีการกำหนดคำสั่งของ if ดังนี้

    if (condition) { // if condition == true do this!!!

    }

* ใช้ ${\color{red}if}$ ไว้อันแรกเลย ถ้าเกิด condtion เรา true จะทำการทำงานใน {}
* ใช้ ${\color{red}else}$ ${\color{red}if}$ เอาไว้ใช้อันรองๆมา ถ้า condition ข้างบน false แล้วอันนี้ true จะทำอันนี้ต่อ แต่ถ้าข้างบน true แล้วก็ไม่ทำเลย
* ใช้ ${\color{red}else}$ เอาไว้ใส่อันท้ายสุด ถ้า condition ข้างบน false หมดเลย จะทำงานในนี้ต่อโดยไม่ลังเล
