...
ในบางวันอาจารย์ก็จะมี lab มาให้ทำด้วย เป็นการทดสอบว่าเด็กเรียนรู้เรื่องรึป่าว ซึ่งถ้าทำไม่ได้อาจจะได้อยู่กับอาจารย์ถึง 2 ทุ่มเลย แต่ก็จะมีพี่ที่เคยเข้าค่ายมากก่อน จะเข้าใจว่าเด็กหลงจากค่ายคณิตที่มาลองเข้าค่ายคอมดูทรมานแค่ไหน พี่เขาก็จะคอยมอบโค้ดให้เด็กตาดำๆมาโดยตลอด ถึงแม้โค้ดนั้นพี่เขาจะไปก็อปมาอีกที แต่ก็ต้องขอขอบคุณมากครับ ไม่อย่างงั้นผมอาจจะทำไม่เสร็จสัก lab แล้วเกลียด coding ไปเลยก็ได้555 
...
ข้อควรระวัง หากเราเผลอเอาค่า index ติดลบ มาใข้ เราจะได้ค่า alien มา
...
| Function | คำอธิบาย |
| :---: | :---: |
| .push_back(x) | เป็นการใส่ค่า x เข้าไปใน vector ต่อกันไปเรื่อยๆ |
| .size() | เราจะได้ค่าของจำนวนสมาชิกใน vector ในตอนนั้น |
| .clear() | เคลียสมาชิกทั้งหมดใน vector |
| .front() | เข้าถึงสมาชิกตัวหน้าสุดของ vector |
| .back() | เข้าถึงสมาชิกตัวหลังสุดของ vector |
| .empty() | จะได้ค่า 1 ถ้าไม่มีสมาชิกใดๆใน vector นอกนั้นได้ค่า 0 |
| .pop_back() | ลบค่าตัวข้างหลังสุด |
| .begin() | เข้าถึงสมาชิกตัวหน้าสุดของ vector แต่เป็น iterator |
| .end() | เข้าถึงสมาชิกตัวหลังสุดของ vector แต่เป็น iterator |
| .erase() | ลบค่าตรงที่ค่าในวงเล็บชี้อยู่ โดยค่าในวงเล็บต้องเป็น iterator |
...
โดยการใช้งานในการรับค่าของผมก็จะทำประมาณนี้ครับ
    ...
    // หรือแบบนี้ แต่ส่วนใหญ่ผมใช้แบบข้างบน ขี้เกียจไปดู maxn ของโจทย์555
