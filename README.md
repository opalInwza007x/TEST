...
ถ้าให้อธิบายก็ กำหนดให้ $a_i$ เป็นการทำงานลำดับที่ i = 0, 1, 2, ...m และให้ $a_j$ เป็นการทำงานลำดับที่ j = 0, 1, 2, ...m ในการทำงานแต่ละครั้งของ $a_i$ จะทำทั้งหมด m ครั้ง แต่ละครั้งก็จะทำงาน $a_j$ ซึ่ง $a_i$ จะทำทั้งหมด n ครั้ง
