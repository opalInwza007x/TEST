...
### ตัวอย่างที่ 1 Coin Change

    "กำหนดให้คุณต้องทอนเงินทั้งหมด m บาท โดนคุณมีเหรียญทั้งหมด n ชนิด ต้องทอนเงินน้อยที่สุดจำนวนกี่เหรียญ"

__Test Case#1__ ต้องทอนเงิน 19 บาท โดยคุณมีเหรียญ 3 ชนิด คือ 1 บาท, 4 บาท, 5 บาท ต้องทอนน้อยที่สุดกี่เหรียญ
...
__Test Case#2__ ต้องทอนเงิน 6 บาท โดยคุณมีเหรียญ 3 ชนิด คือ 1 บาท, 3 บาท, 4 บาท ต้องทอนน้อยที่สุดกี่เหรียญ
...
__ขั้นเท่าไหร่ไม่รู้ optimize แบบ coolๆ__
...
คำตอบของเราจะเกิดจากการเรียก `solve(n - 1, m - 1)` ซึ่งมันดีกว่าตรงที่เราไม่ต้องประกาศ `n` และ `m` เป็น global เพื่อที่จะเช็คว่าเลยขอบหรือถึงจุดหมายรึยัง ในแบบนี้เราสามารถเช็คได้จากค่า index หรือก็คือ 0 ได้เลย
...
### ตัวอย่างที่ 3 Grid Paths

[ทดลองทำเอง](https://cses.fi/problemset/task/1638)

    "กำหนดตารางมาให้ขนาด n × m โดยแต่ละช่องจะมีช่องว่าง `.` และสิ่งกิดขวาง `*` ต้องการทราบจำนวนเส้นทางที่สามารถเดินไปได้จากซ้ายบนไปยังขวาล่าง mod ด้วย 1e9 + 7 โดยที่สามารถเดินไปได้แค่ทิศขวากับล่างเท่านั้น"
...
กำหนดให้ a, b, c, d เป็นแค่ 0 และ 1
