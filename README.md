...
ในการประกาศชื่อตัวแปรก็ 

    <ชนิดตัวแปร> ชื่อตัวแปร;
    long long n;
    bool amogus;
    
ขอแค่ชื่อไม่ตรงกับ[ฟังก์ชัน](https://www.informit.com/articles/article.aspx?p=2755729&seqNum=7)ที่เขามีให้ก็ตั้งได้แน่นอนครับ ไม่งั้นคุณอาจจะได้นั่งแก้ข้ามวัน >:3
...
ถ้าต้องการแสดงผลค่าหลายตัวในบรรทัดเดียวก็ทำแบบนี้เลยครับ
    ...
    cout << "please insert n : ";
    cin >> n;
    cout << "value of n = " << n << " <- n is this number";
