...
ขอนี้ก็ใช้ Matrix Chain Multiplication เลยครับ ผมทำแบบ Top-Down โดยสังเกตุได้ว่าต้นไม้จะสร้างได้ทั้งหมด (จำนวนที่สร้างได้แบบซ้าย * จำนวนที่สร้างได้แบบขวา)
...
ข้อนี้ไม่รู้ทำไมในห้องสอบผมคิดไม่ออก พอออกห้องมามีเพื่อนบอกให้ดูจากล่างขึ้นบน sol ขึ้นมาเต็มเลย555 เก็บ subtasks มาได้ 11 คะแนน
